...
import { ArrowRight, Beef, Droplet, Wheat, Bone, FlaskConical, Package, Mail, ChevronRight } from "lucide-react";
import {
    BRAND,
    FEED_NUTRITION,
    FEED_MINERALS,
                    ...
                    <div className="grid lg:grid-cols-12 gap-10">
                        ...
                        <div className="lg:col-span-5">
                            <div className="rounded-3xl border border-amber-500/20 bg-black/30 p-6 h-full">
                                <div className="aspect-[4/5] rounded-2xl bg-gradient-to-br from-[#0F1F36] via-[#1A365D]/50 to-[#050B14] border border-white/10 flex items-center justify-center relative overflow-hidden">
                                    <div className="absolute inset-0 bg-[radial-gradient(circle_at_50%_50%,rgba(46,92,66,0.3),transparent_55%)]" />
                                    <div className="relative text-center px-6">
                                        <div className="font-mono text-[10px] tracking-[0.3em] uppercase text-amber-200/80">FBAM · Frozen Block</div>
                                        <div className="font-serif text-4xl mt-3 text-white">−18 °C</div>
                                        <div className="mt-3 text-xs text-slate-400 font-mono">Peak nutrient retention</div>
                                    </div>
                                </div>
